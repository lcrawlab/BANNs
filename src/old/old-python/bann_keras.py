...
class BANN_Quantitative:
	def __init__(self, layers, p, l_rate):
		...
		self.G1_loc = self.model.layers[-1].spike_posterior.distribution.loc
		self.G1_scale = self.model.layers[-1].spike_posterior.distribution.scale
